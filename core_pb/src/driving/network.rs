...
impl<T: RobotBehavior> NetworkData<T> {
    ...
    // }
    //
    // async fn send(&mut self, socket: &mut T::Network::Socket<'_>, message: RobotToServerMessage) {
    //     self.write_tcp(socket, BytesOrT::T(message)).await;
    // }
    //
    // async fn send_bytes(&mut self, socket: &mut T::Network::Socket<'_>, bytes: &[u8]) {
    //     self.write_tcp(socket, BytesOrT::Bytes(bytes)).await;
    // }
    //
    // async fn write_tcp(
    //     &mut self,
    //     socket: &mut T::Network::Socket<'_>,
    ...
    //     self.data
    //         .network_status
    //         .swap((status, ip), Ordering::Relaxed);
    // }
    //
    // async fn handle_inter_task_message(
    //     &mut self,
    //     s: &mut T::Network::Socket<'_>,
